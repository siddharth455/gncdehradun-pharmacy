...
<div class="banner-area about" style="background-image: url(assets/images/banner/5.webp);">
    <div class="d-table">
                ...
                <div class="col-md-4 col-12 ">
                    <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <button class="nav-link approvals-link active" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true">
                            <img src="assets/images/bio.jpg" alt="Home Icon" class="button-icon"> Sharon BIO Medicine LTD. , Dehradun
                        </button>
                ...
                <div class="col-md-8 col-12">
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab" tabindex="0">
                            <h4 style="text-align: center;">Sharon BIO Medicine LTD. , Dehradun</h4>
                        ...
                        <div class="tab-pane fade show" id="v-pills-UGC" role="tabpanel" aria-labelledby="v-pills-UGC-tab" tabindex="0">
                            ...
                            <div class="pdf-container">
                                <embed src="assets/images/Gurukul Kangri.pdf#page=1" type="application/pdf" width="100%" height="100%">
                            </div>
                        </div>
