...
<div class="banner-area about" style="background-image: url(assets/images/d-1.webp);">
    <div class="d-table">
        <div class="d-table-cell">
            <div class="container">
                <div class="page-title-content">
                    <h2>Bachelor in Pharmacy <br>Lateral Entry</h2>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="aboutProgram-section__content">
                    ...
                    <div class="page-sub-heading mt-2">
                    ...
                    <a href="https://gncdehradun.com/pharmacy-college.php?utm_source=Pharmacy-website&utm_medium=Online&utm_campaign=Pharmacy-website" class="btn btn-lg btn-shadow applyNow_button" style="background-color: #00bcfb;">Apply Now <i class="fa fa-long-arrow-right ms-1" aria-hidden="true"></i></a>

                </div>
            </div>
            <div class="col-lg-6">
            <iframe src="https://www.youtube.com/embed/Hf9j2CCXBto?autoplay=1&amp;mute=1&amp;playlist=Hf9j2CCXBto&amp;loop=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen="" id="gdlr-video-411196" width="100%" height="100%"></iframe>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-lg-8">
                ...
                <div class="tabs-style mb-5">
                    ...
                    <div class="course-heading">
                            <h2 style="text-align: center;">Lateral Entry Bachelor in Pharmacy</h2>
                        </div>
...
<section class="pt-2 pb-2 admissionProcess">
    <div class="container">
...
<script>
    ...
    `);
        ...
        windowPrint.document.write('<img id="logo" src="assets/images/logo-desktop.webp" alt="Logo">');
