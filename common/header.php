    ...
    <div class="navbar-area">
        ...
        <div class="mobile-nav">
            <a href="index.php" class="logo">
                ...
                <img src="assets/images/logo-phone-white.webp" class="white-logo" alt="logo" />
            </a>
        </div>
        <div class="main-nav">
            <div class="container">
                <nav class="navbar navbar-expand-md navbar-light">
                    <a class="navbar-brand" href="index.php">
                        <img src="assets/images/logo-desktop.webp" class="main-logo" alt="logo" />
                        <img src="assets/images/logo-desktop-white.webp" class="white-logo" alt="logo" />
                    </a>
