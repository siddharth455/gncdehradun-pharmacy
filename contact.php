...
<section class="contactus container">
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 contact-item">
            ...
            <h4>Location</h4>
            <p>Jhajhra, Chakrata Rd, Dehradun, Uttarakhand 248007</p>
            <p><a href="https://maps.app.goo.gl/WWNhKqccPRahyEya9" target="_blank" class="contact-link">View On Google Map</a></p>
        </div>
    </div>
</section>
