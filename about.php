...
<section class="otherContent-section " style="background-image: url(assets/images/about-background.webp); background-size: cover;background-position: top; background-repeat: no-repeat; ">
    <div style="background-color: #f59445d9;">
